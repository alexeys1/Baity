...
public class FancyCreeperVeil implements WorldRenderEvents.AfterEntities {
    ...
    private static final Identifier WITHER_CLOAK_SHIELD = Identifier.fromNamespaceAndPath("baity", "textures/wither_cloak_shield.png");
    ...
    private void renderShield(PoseStack matrices, MultiBufferSource buffers) {
        VertexConsumer consumer = buffers.getBuffer(RenderTypes.entityCutout(WITHER_CLOAK_SHIELD));
